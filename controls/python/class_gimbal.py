...
class XYGimbal():
	# Simple 2-servo gimbal, X & Y axis
        def __init__(self,(xchannelid,xmin,xmax,xneutral),(ychannelid,ymin,ymax,yneutral)):
                self.XServo = servo.StandardServo(xchannelid,xmin,xmax,xneutral)
                self.YServo = servo.StandardServo(ychannelid,ymin,ymax,yneutral)
