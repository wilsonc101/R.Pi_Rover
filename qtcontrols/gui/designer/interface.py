...
#
# Created: Sun Dec 13 01:01:36 2015
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tab_sensors.setGeometry(QtCore.QRect(287, 10, 281, 171))
        ...
        self.listView.setGeometry(QtCore.QRect(0, 0, 277, 140))
        self.listView.setObjectName(_fromUtf8("listView"))
        self.tab_sensors.addTab(self.tab, _fromUtf8(""))
        ...
        self.btn_cam_still.setGeometry(QtCore.QRect(10, 202, 31, 31))
        icon = QtGui.QIcon()
        ...
        self.label = QtGui.QLabel(self.frame_camera)
        self.label.setGeometry(QtCore.QRect(44, 203, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lbl_cam_correl = QtGui.QLabel(self.frame_camera)
        self.lbl_cam_correl.setGeometry(QtCore.QRect(44, 217, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        self.lbl_cam_correl.setFont(font)
        self.lbl_cam_correl.setText(_fromUtf8(""))
        self.lbl_cam_correl.setObjectName(_fromUtf8("lbl_cam_correl"))
        ...
        MainWindow.setTabOrder(self.btn_stop, self.btn_forward)
        MainWindow.setTabOrder(self.btn_forward, self.btn_reverse)
        MainWindow.setTabOrder(self.btn_reverse, self.btn_left)
        MainWindow.setTabOrder(self.btn_left, self.btn_right)
        MainWindow.setTabOrder(self.btn_right, self.btn_left_full)
        MainWindow.setTabOrder(self.btn_left_full, self.btn_right_full)
        MainWindow.setTabOrder(self.btn_right_full, self.cb_brake)
        MainWindow.setTabOrder(self.cb_brake, self.slider_cam_tilt)
        MainWindow.setTabOrder(self.slider_cam_tilt, self.dial_cam_pan)
        MainWindow.setTabOrder(self.dial_cam_pan, self.btn_cam_reset)
        MainWindow.setTabOrder(self.btn_cam_reset, self.cb_cam_light)
        MainWindow.setTabOrder(self.cb_cam_light, self.cb_veh_light)
        MainWindow.setTabOrder(self.cb_veh_light, self.btn_open_player)
        MainWindow.setTabOrder(self.btn_open_player, self.tab_sensors)
        MainWindow.setTabOrder(self.tab_sensors, self.btn_shutdown)
        MainWindow.setTabOrder(self.btn_shutdown, self.tb_temperature)
        MainWindow.setTabOrder(self.tb_temperature, self.gv_accel_rf)
        MainWindow.setTabOrder(self.gv_accel_rf, self.tb_gps_altitude)
        MainWindow.setTabOrder(self.tb_gps_altitude, self.tb_gps_speed)
        MainWindow.setTabOrder(self.tb_gps_speed, self.tb_pressure)
        MainWindow.setTabOrder(self.tb_pressure, self.gv_accel_lr)
        MainWindow.setTabOrder(self.gv_accel_lr, self.tb_gps_long)
        MainWindow.setTabOrder(self.tb_gps_long, self.tb_humidity)
        MainWindow.setTabOrder(self.tb_humidity, self.tb_gps_lat)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tab_sensors.setTabText(self.tab_sensors.indexOf(self.tab), _translate("MainWindow", "Stills", None))
...
"Vehicle", None))
        ...
        self.btn_cam_still.setText(_translate("MainWindow", "...", None))
        self.label.setText(_translate("MainWindow", "Last correl:", None))
    ...
    def translateQueueData(self, queue_data):
        ...
        actions.GUIUpdate(self, json_data)
